...
const tiles = {
  f01: ['03','04','05','61','63','65','82','84','88','91','92','94','95','96','97','98','99'],
    ...
    FABRICS.forEach((fab,i)=>{
      ...
      card.style.backgroundImage = `url('./images/sofas/kornilon/${folders[fab.code]}/${tiles[fab.code][0]}.jpg')`;
      ...
      title.addEventListener('click', ()=>{
        ...
        if (!palette.childElementCount){
          tiles[fab.code].forEach(n=>{
            ...
            sw.style.background=`url('./images/sofas/kornilon/${folders[fab.code]}/${n}.jpg') center/cover no-repeat`;
            sw.innerHTML=`<span class="sw-badge">${n}</span>`;
            sw.onclick=()=>{
              card.style.backgroundImage=`url('./images/sofas/kornilon/${folders[fab.code]}/${n}.jpg')`;
