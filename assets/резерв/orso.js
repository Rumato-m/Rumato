document.addEventListener('DOMContentLoaded', () => {
  ...
  const SOFA_BASE = 'images/sofas/orso';
  ...
  const PLACEHOLDER_IMG = (() => {
    const svg = encodeURIComponent(`<svg xmlns='http://www.w3.org/2000/svg' width='800' height='400'>
      ...
      <text x='50%' y='50%' dominant-baseline='middle' text-anchor='middle'
        ...
        Попередній перегляд дивана Orso
      </text>
    </svg>`);
...
• Для зон інтенсивного використання обирайте відтінки середньої насиченості.`
  ...
  const articleContent = {
    ...
    philosophy: {
      ...
      body: 'Orso задуманий не як «предмет інтерʼєру», а як частина вашого життя. Глибоке сидіння дозволяє не просто сісти рівно, а вмоститися так, як вам зручно насправді. Модульність означає, що диван можна підігнати під кімнату сьогодні — і змінити, коли зміниться простір, без купівлі нового. Опція розкладного механізму — це ще один рівень турботи: гість може залишитися на ніч, а вітальня при цьому не втрачає вигляду. Ми вважаємо, що справжній комфорт — це коли дім працює під вас, а не навпаки.'
    }
  };
